...
| [fletcher / MultiMarkdown-6][25]                                    | 599       | `2023/12/30` | C          | CLI                      | ⭐⭐⭐⭐⭐                    |
| [gajus / gitdown][26]                                               | 448       | `2022/03/01` | JS         | CLI                      | ⭐⭐⭐⭐⭐                    |
| [gpoore / codebraid][27]                                            | 362       | `2023/10/17` | Python     | CLI                      | ⭐⭐⭐⭐⭐                    |
| [amyreese / markdown-pp][28] (archived)                             | 307       | `2021/09/02` | Python     | CLI                      | ⭐⭐⭐⭐⭐                    |
| [zakhenry / embedme][29]                                            | 222       | `2023/11/08` | JS         | CLI                      | ⭐⭐⭐⭐⭐                    |
| [DCsunset / pandoc-include][30]                                     | 62        | `2024/04/30` | Python     | Pandoc / CLI             | ⭐⭐⭐⭐⭐                    |
| [BurdetteLamar / markdown_helper][31]                               | 38        | `2020/03/16` | Ruby       | CLI                      | ⭐⭐⭐⭐⭐                    |
| [SimonCropp / MarkdownSnippets][32]                                 | 23        | `2024/04/23` | .NET       | CLI                      | ⭐⭐⭐⭐⭐                    |
| [endocode / snippetextractor][33]                                   | 4         | `2014/08/16` | C++        | CLI                      | ⭐⭐⭐⭐⭐                    |
| [polywrap / doc-snippets][34]                                       | 3         | `2023/09/26` | JS         | CLI                      | ⭐⭐⭐⭐⭐                    |
| [hxtmike / markdown_include][35]                                    | 2         | `2024/05/09` | Python     | CLI                      | ⭐⭐⭐⭐⭐                    |
| [JulianCataldo / remark-embed][36]                                  | 2         | `2022/09/22` | JS         | JS / library             | ⭐⭐⭐⭐⭐                    |
| [xrd / oreilly-snippets][37]                                        | 2         | `2015/10/15` | Ruby       | Ruby / library           | ⭐⭐⭐⭐⭐                    |
| [DamonOehlman / injectcode][38]                                     | 1         | `2021/08/01` | JS         | CLI                      | ⭐⭐⭐⭐⭐                    |
| [electrovir / markdown-code-example-inserter][39]                   | 1         | `2024/02/19` | JS         | CLI                      | ⭐⭐⭐⭐⭐                    |
| [andersfischernielsen / Simple-Embedded-Markdown-Code-Snippets][40] | 1         | `2021/02/12` | JS         | CLI                      | ⭐⭐⭐⭐⭐                    |
| [ildar-shaimordanov / git-markdown-snippet][41]                     | 0         | `2021/09/14` | Perl       | CLI                      | ⭐⭐⭐⭐⭐                    |
| [teyc / markdown-snippet][42]                                       | 0         | `2024/01/22` | Powershell | Powershell / function    | ⭐⭐⭐⭐                     |
| [marc-bouvier-graveyard / baldir_markdown][43]                      | 0         | `2020/06/15` | Python     | CLI                      | ⭐⭐⭐⭐⭐                    |
| [facelessuser / pymdown-extensions][44] ([snippets][45])            | 903       | `2024/05/05` | Python     | Python / PyMarkdown      | ⭐⭐⭐⭐                     |
| [dineshsonachalam / markdown-autodocs][46]                          | 176       | `2022/09/19` | JS         | GH Action                | ⭐⭐⭐⭐                     |
| [sethen / markdown-include][47]                                     | 148       | `2017/10/26` | JS         | CLI+config               | ⭐⭐⭐⭐                     |
| [cmacmackin / markdown-include][48]                                 | 95        | `2023/02/07` | Python     | Python / library         | ⭐⭐⭐⭐                     |
| [tokusumi / markdown-embed-code][49]                                | 28        | `2022/01/05` | Python     | GH Action                | ⭐⭐⭐⭐                     |
| [sammndhr / gridsome-remark-embed-snippet][50]                      | 2         | `2021/06/14` | JS         | [Gridsome][51]           | ⭐⭐⭐⭐                     |
| [NativeScript / markdown-snippet-injector][52]                      | 4         | `2019/01/24` | JS         | CLI                      | ⭐⭐⭐⭐                     |
| [fossunited/markdown-macros][53]                                    | 0         | `2021/06/10` | Python     | Python / Python-Markdown | ⭐⭐⭐⭐                     |
| [fuxingloh / remark-code-import-replace][54]                        | 0         | `2022/12/21` | JS         | Remark?                  | ⭐⭐⭐⭐                     |
| [szkiba / mdcode][55]                                               | 15        | `2014/02/12` | Go         | CLI                      | ⭐⭐⭐                      |
| [devincornell/pymddoc][56]                                          | 0         | `2023/12/01` | Python     | Python                   | ⭐⭐⭐                      |
| [shiftkey / scribble][57] ([docs][58])                              | 40        | `2013/08/08` | .NET       | CLI                      | ⭐⭐                       |
| [calebpeterson / jest-transformer-test-md][59]                      | 2         | `2020/08/21` | JS         | Jest Tests               | ⭐⭐                       |
| [tjstankus / commitate][60]                                         | 0         | `2014/05/29` | Ruby       | CLI                      | ⭐                        |
| [GitHub Docs: Creating a permanent link to a code snippet][61]      | N/A       | N/A          | N/A        | GitHub                   | ⭐                        |
| [javierfernandes / markdown-exercises][62]                          | 1         | `2017/05/01` | JS         | N/A                      | ⭐                        |
| [gatsby-remark-embed-snippet][63]                                   | N/A (55k) | `2024/01/23` | JS         | [Gatsby][64]             | ⭐                        |
| [ARMmbed / snippet][65] ([docs][66])                                | 6         | `2021/08/05` | Python     | CLI                      | ⭐                        |
| [drewavis / markdowninclude][67]                                    | 1         | `2024/04/06` | JS         | VSCode Extension         | ?                        |
| [romnn / embedme][68]                                               | 0         | `2024/04/18` | Go         | N/A                      | ⭐                        |
...
[25]: https://github.com/fletcher/MultiMarkdown-6
[26]: https://github.com/gajus/gitdown
[27]: https://github.com/gpoore/codebraid
[28]: https://github.com/amyreese/markdown-pp "Archived"
[29]: https://github.com/zakhenry/embedme
[30]: https://github.com/DCsunset/pandoc-include
[31]: https://github.com/BurdetteLamar/markdown_helper
[32]: https://github.com/SimonCropp/MarkdownSnippets
[33]: https://github.com/endocode/snippetextractor
[34]: https://github.com/polywrap/doc-snippets
[35]: https://github.com/hxtmike/markdown_include
[36]: https://github.com/JulianCataldo/remark-embed
[37]: https://github.com/xrd/oreilly-snippets
[38]: https://github.com/DamonOehlman/injectcode
[39]: https://github.com/electrovir/markdown-code-example-inserter
[40]: https://github.com/andersfischernielsen/Simple-Embedded-Markdown-Code-Snippets
[41]: https://github.com/ildar-shaimordanov/git-markdown-snippet
[42]: https://github.com/teyc/markdown-snippet
[43]: https://github.com/marc-bouvier-graveyard/baldir_markdown
[44]: https://github.com/facelessuser/pymdown-extensions
[45]: https://facelessuser.github.io/pymdown-extensions/extensions/snippets/
[46]: https://github.com/dineshsonachalam/markdown-autodocs
[47]: https://github.com/sethen/markdown-include "CLI but requires that you make a json file with various optiosn to produce the output"
[48]: https://github.com/cmacmackin/markdown-include
[49]: https://github.com/tokusumi/markdown-embed-code
[50]: https://github.com/sammndhr/gridsome-remark-embed-snippet
[51]: https://gridsome.org/
[52]: https://github.com/NativeScript/markdown-snippet-injector
[53]: https://github.com/fossunited/markdown-macros
[54]: https://github.com/fuxingloh/remark-code-import-replace
[55]: https://github.com/szkiba/mdcode "Extracts code blocks from README and produces tests; a similar approach, but quite different"
[56]: https://github.com/devincornell/pymddoc
[57]: https://github.com/shiftkey/scribble
[58]: https://github.com/shiftkey/scribble/blob/master/docs/features/code-snippets.md
[59]: https://github.com/calebpeterson/jest-transformer-test-md
[60]: https://github.com/tjstankus/commitate "Missing usage example"
[61]: https://docs.github.com/en/get-started/writing-on-github/working-with-advanced-formatting/creating-a-permanent-link-to-a-code-snippet
[62]: https://github.com/javierfernandes/markdown-exercises "This doesn't embed files, rather allows markdown code sections to be tested, no usage example"
[63]: https://github.com/gatsbyjs/gatsby/tree/master/packages/gatsby-remark-embed-snippet
[64]: https://github.com/gatsbyjs/gatsby
[65]: https://github.com/ARMmbed/snippet "Unclear from documentation on how to embed the code into the template"
[66]: https://github.com/ARMmbed/snippet/blob/master/USAGE.md
[67]: https://github.com/drewavis/markdowninclude
[68]: https://github.com/romnn/embedme "Documentation is lacking"

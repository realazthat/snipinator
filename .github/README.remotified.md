...
- Projects using Snipinator:
  - [realazthat/snipinator][24]
    ...
    - Generating script: [snipinator/scripts/generate-readme.sh#L20][26].
  - [realazthat/mdremotifier][27].
    - Template: [mdremotifier/README.md.jinja2][28].
    - Generating script: [mdremotifier/generate-readme.sh#L20][29].
  - [realazthat/changeguard][30].
    - Template: [changeguard/README.md.jinja2][31].
  - [realazthat/comfy-catapult][32].
    - Template: [comfy-catapult/README.md.jinja2][33].
  - [realazthat/comfylowda][34].
    - Template: [comfylowda/README.md.jinja2][35].
...
| ------------------------------------------------------------------- | --------- | ------------ | ---------- | ------------------------ | ------------------------ |
| [mdx-js / mdx][38]                                                  | 16.8k     | `2024/04/17` | JS         | N/A                      | ⭐⭐⭐⭐⭐                    |
| [fletcher / MultiMarkdown-6][39]                                    | 599       | `2023/12/30` | C          | CLI                      | ⭐⭐⭐⭐⭐                    |
| [gajus / gitdown][40]                                               | 448       | `2022/03/01` | JS         | CLI                      | ⭐⭐⭐⭐⭐                    |
| [gpoore / codebraid][41]                                            | 362       | `2023/10/17` | Python     | CLI                      | ⭐⭐⭐⭐⭐                    |
| [amyreese / markdown-pp][42] (archived)                             | 307       | `2021/09/02` | Python     | CLI                      | ⭐⭐⭐⭐⭐                    |
| [zakhenry / embedme][43]                                            | 222       | `2023/11/08` | JS         | CLI                      | ⭐⭐⭐⭐⭐                    |
| [DCsunset / pandoc-include][44]                                     | 62        | `2024/04/30` | Python     | Pandoc / CLI             | ⭐⭐⭐⭐⭐                    |
| [BurdetteLamar / markdown_helper][45]                               | 38        | `2020/03/16` | Ruby       | CLI                      | ⭐⭐⭐⭐⭐                    |
| [SimonCropp / MarkdownSnippets][46]                                 | 23        | `2024/04/23` | .NET       | CLI                      | ⭐⭐⭐⭐⭐                    |
| [endocode / snippetextractor][47]                                   | 4         | `2014/08/16` | C++        | CLI                      | ⭐⭐⭐⭐⭐                    |
| [polywrap / doc-snippets][48]                                       | 3         | `2023/09/26` | JS         | CLI                      | ⭐⭐⭐⭐⭐                    |
| [hxtmike / markdown_include][49]                                    | 2         | `2024/05/09` | Python     | CLI                      | ⭐⭐⭐⭐⭐                    |
| [JulianCataldo / remark-embed][50]                                  | 2         | `2022/09/22` | JS         | JS / library             | ⭐⭐⭐⭐⭐                    |
| [xrd / oreilly-snippets][51]                                        | 2         | `2015/10/15` | Ruby       | Ruby / library           | ⭐⭐⭐⭐⭐                    |
| [DamonOehlman / injectcode][52]                                     | 1         | `2021/08/01` | JS         | CLI                      | ⭐⭐⭐⭐⭐                    |
| [electrovir / markdown-code-example-inserter][53]                   | 1         | `2024/02/19` | JS         | CLI                      | ⭐⭐⭐⭐⭐                    |
| [andersfischernielsen / Simple-Embedded-Markdown-Code-Snippets][54] | 1         | `2021/02/12` | JS         | CLI                      | ⭐⭐⭐⭐⭐                    |
| [ildar-shaimordanov / git-markdown-snippet][55]                     | 0         | `2021/09/14` | Perl       | CLI                      | ⭐⭐⭐⭐⭐                    |
| [teyc / markdown-snippet][56]                                       | 0         | `2024/01/22` | Powershell | Powershell / function    | ⭐⭐⭐⭐                     |
| [marc-bouvier-graveyard / baldir_markdown][57]                      | 0         | `2020/06/15` | Python     | CLI                      | ⭐⭐⭐⭐⭐                    |
| [facelessuser / pymdown-extensions][58] ([snippets][59])            | 903       | `2024/05/05` | Python     | Python / PyMarkdown      | ⭐⭐⭐⭐                     |
| [dineshsonachalam / markdown-autodocs][60]                          | 176       | `2022/09/19` | JS         | GH Action                | ⭐⭐⭐⭐                     |
| [sethen / markdown-include][61]                                     | 148       | `2017/10/26` | JS         | CLI+config               | ⭐⭐⭐⭐                     |
| [cmacmackin / markdown-include][62]                                 | 95        | `2023/02/07` | Python     | Python / library         | ⭐⭐⭐⭐                     |
| [tokusumi / markdown-embed-code][63]                                | 28        | `2022/01/05` | Python     | GH Action                | ⭐⭐⭐⭐                     |
| [sammndhr / gridsome-remark-embed-snippet][64]                      | 2         | `2021/06/14` | JS         | [Gridsome][65]           | ⭐⭐⭐⭐                     |
| [NativeScript / markdown-snippet-injector][66]                      | 4         | `2019/01/24` | JS         | CLI                      | ⭐⭐⭐⭐                     |
| [fossunited/markdown-macros][67]                                    | 0         | `2021/06/10` | Python     | Python / Python-Markdown | ⭐⭐⭐⭐                     |
| [fuxingloh / remark-code-import-replace][68]                        | 0         | `2022/12/21` | JS         | Remark?                  | ⭐⭐⭐⭐                     |
| [szkiba / mdcode][69]                                               | 15        | `2014/02/12` | Go         | CLI                      | ⭐⭐⭐                      |
| [devincornell/pymddoc][70]                                          | 0         | `2023/12/01` | Python     | Python                   | ⭐⭐⭐                      |
| [shiftkey / scribble][71] ([docs][72])                              | 40        | `2013/08/08` | .NET       | CLI                      | ⭐⭐                       |
| [calebpeterson / jest-transformer-test-md][73]                      | 2         | `2020/08/21` | JS         | Jest Tests               | ⭐⭐                       |
| [tjstankus / commitate][74]                                         | 0         | `2014/05/29` | Ruby       | CLI                      | ⭐                        |
| [GitHub Docs: Creating a permanent link to a code snippet][75]      | N/A       | N/A          | N/A        | GitHub                   | ⭐                        |
| [javierfernandes / markdown-exercises][76]                          | 1         | `2017/05/01` | JS         | N/A                      | ⭐                        |
| [gatsby-remark-embed-snippet][77]                                   | N/A (55k) | `2024/01/23` | JS         | [Gatsby][78]             | ⭐                        |
| [ARMmbed / snippet][79] ([docs][80])                                | 6         | `2021/08/05` | Python     | CLI                      | ⭐                        |
| [drewavis / markdowninclude][81]                                    | 1         | `2024/04/06` | JS         | VSCode Extension         | ?                        |
| [romnn / embedme][82]                                               | 0         | `2024/04/18` | Go         | N/A                      | ⭐                        |
...
[26]: https://github.com/realazthat/snipinator/blob/376cb1d83124ad00ce7c2a887d713ac2a85b9258/scripts/generate-readme.sh#L20
[27]: https://github.com/realazthat/mdremotifier
[28]: https://github.com/realazthat/mdremotifier/blob/b1ea58ebb4f1b223719c6103d67ed5d588e66181/README.md.jinja2
[29]: https://github.com/realazthat/mdremotifier/blob/b1ea58ebb4f1b223719c6103d67ed5d588e66181/scripts/generate-readme.sh#L20
[30]: https://github.com/realazthat/changeguard
[31]: https://github.com/realazthat/changeguard/blob/87d5104b52e651bb9195a3d46dd7f050acbcb534/README.md.jinja2
[32]: https://github.com/realazthat/comfy-catapult
[33]: https://github.com/realazthat/comfy-catapult/blob/ff353d48b25fa7b9c35fa11b31d5f2b3039c41c8/README.md.jinja2
[34]: https://github.com/realazthat/comfylowda
[35]: https://github.com/realazthat/comfylowda/blob/e01a32c38107aa0b89ccea21c4678d193a186a78/README.md.jinja2
[36]: https://github.com/realazthat/excalidraw-brute-export-cli
[37]: https://github.com/realazthat/excalidraw-brute-export-cli/blob/54a3b5b08b644e61c721ab565c576094234c5cc7/README.md.jinja2
[38]: https://github.com/mdx-js/mdx
[39]: https://github.com/fletcher/MultiMarkdown-6
[40]: https://github.com/gajus/gitdown
[41]: https://github.com/gpoore/codebraid
[42]: https://github.com/amyreese/markdown-pp "Archived"
[43]: https://github.com/zakhenry/embedme
[44]: https://github.com/DCsunset/pandoc-include
[45]: https://github.com/BurdetteLamar/markdown_helper
[46]: https://github.com/SimonCropp/MarkdownSnippets
[47]: https://github.com/endocode/snippetextractor
[48]: https://github.com/polywrap/doc-snippets
[49]: https://github.com/hxtmike/markdown_include
[50]: https://github.com/JulianCataldo/remark-embed
[51]: https://github.com/xrd/oreilly-snippets
[52]: https://github.com/DamonOehlman/injectcode
[53]: https://github.com/electrovir/markdown-code-example-inserter
[54]: https://github.com/andersfischernielsen/Simple-Embedded-Markdown-Code-Snippets
[55]: https://github.com/ildar-shaimordanov/git-markdown-snippet
[56]: https://github.com/teyc/markdown-snippet
[57]: https://github.com/marc-bouvier-graveyard/baldir_markdown
[58]: https://github.com/facelessuser/pymdown-extensions
[59]: https://facelessuser.github.io/pymdown-extensions/extensions/snippets/
[60]: https://github.com/dineshsonachalam/markdown-autodocs
[61]: https://github.com/sethen/markdown-include "CLI but requires that you make a json file with various optiosn to produce the output"
[62]: https://github.com/cmacmackin/markdown-include
[63]: https://github.com/tokusumi/markdown-embed-code
[64]: https://github.com/sammndhr/gridsome-remark-embed-snippet
[65]: https://gridsome.org/
[66]: https://github.com/NativeScript/markdown-snippet-injector
[67]: https://github.com/fossunited/markdown-macros
[68]: https://github.com/fuxingloh/remark-code-import-replace
[69]: https://github.com/szkiba/mdcode "Extracts code blocks from README and produces tests; a similar approach, but quite different"
[70]: https://github.com/devincornell/pymddoc
[71]: https://github.com/shiftkey/scribble
[72]: https://github.com/shiftkey/scribble/blob/master/docs/features/code-snippets.md
[73]: https://github.com/calebpeterson/jest-transformer-test-md
[74]: https://github.com/tjstankus/commitate "Missing usage example"
[75]: https://docs.github.com/en/get-started/writing-on-github/working-with-advanced-formatting/creating-a-permanent-link-to-a-code-snippet
[76]: https://github.com/javierfernandes/markdown-exercises "This doesn't embed files, rather allows markdown code sections to be tested, no usage example"
[77]: https://github.com/gatsbyjs/gatsby/tree/master/packages/gatsby-remark-embed-snippet
[78]: https://github.com/gatsbyjs/gatsby
[79]: https://github.com/ARMmbed/snippet "Unclear from documentation on how to embed the code into the template"
[80]: https://github.com/ARMmbed/snippet/blob/master/USAGE.md
[81]: https://github.com/drewavis/markdowninclude
[82]: https://github.com/romnn/embedme "Documentation is lacking"

...
Turn this ([./examples/SIMPLE.md.jinja2](https://github.com/realazthat/snipinator/blob/v3.1.2/examples/SIMPLE.md.jinja2)):
...
<!--{{ pysnippet(path='examples/code.py', symbol='MyClass', backtickify='py', decomentify='nl') }}-->

Note that `code.py` has a test:
{{path('./examples/code_test.py', link='md')}}.

```
<!---->

Into this ([./examples/SIMPLE.generated.md](https://github.com/realazthat/snipinator/blob/v3.1.2/examples/SIMPLE.generated.md)):
...
Example template README: ([./examples/SIMPLE.md.jinja2](https://github.com/realazthat/snipinator/blob/v3.1.2/examples/SIMPLE.md.jinja2)):
...
<!---->
````bash
$ python -m snipinator.cli -t examples/SIMPLE.md.jinja2
<!--
...
<!---->
<img alt="Output of `bash ./examples/simple_example.sh`" src="https://raw.githubusercontent.com/realazthat/snipinator/v3.1.2/.github/README.example.generated.svg"/>
<!-- -->
...
- Example:
  - Template: [./examples/SIMPLE.md.jinja2](https://github.com/realazthat/snipinator/blob/v3.1.2/examples/SIMPLE.md.jinja2).
  - Generated: [./examples/SIMPLE.generated.md](https://github.com/realazthat/snipinator/blob/v3.1.2/examples/SIMPLE.generated.md).
  - Generation script: [./examples/simple_example.sh](https://github.com/realazthat/snipinator/blob/v3.1.2/examples/simple_example.sh).
- Long example of many features:
  - Template: [./examples/LONG-EXAMPLE.md.jinja2](https://github.com/realazthat/snipinator/blob/v3.1.2/examples/LONG-EXAMPLE.md.jinja2).
  - Generated: [./examples/LONG-EXAMPLE.generated.md](https://github.com/realazthat/snipinator/blob/v3.1.2/examples/LONG-EXAMPLE.generated.md).
  - Generation script: [./examples/long_example.sh](https://github.com/realazthat/snipinator/blob/v3.1.2/examples/long_example.sh).
...
Used several times in [./examples/LONG-EXAMPLE.md.jinja2](https://github.com/realazthat/snipinator/blob/v3.1.2/examples/LONG-EXAMPLE.md.jinja2).
...
Example in [./examples/LONG-EXAMPLE.md.jinja2](https://github.com/realazthat/snipinator/blob/v3.1.2/examples/LONG-EXAMPLE.md.jinja2).
...
docker run --rm --tty \
  ...
  -t "examples/SIMPLE.md.jinja2" \
  --rm \
  --force \
  --create \
  -o "examples/SIMPLE.generated.md" \
  --chmod-ro \
  --skip-unchanged

# View the generated file.
cat "examples/SIMPLE.generated.md"
...
- Formatting: The `{{` `}}` used to
  ...
  - **Decommentify**: Put the snippet call inside a HTML comment, then use
    ...
    [./examples/LONG-EXAMPLE.md.jinja2](https://github.com/realazthat/snipinator/blob/v3.1.2/examples/LONG-EXAMPLE.md.jinja2) for examples.

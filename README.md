...
Turn this ([./examples/SIMPLE.md.jinja2](./examples/SIMPLE.md.jinja2)):
...
Into this ([./examples/SIMPLE.generated.md](./examples/SIMPLE.generated.md)):
...
Example template README: ([./examples/SIMPLE.md.jinja2](./examples/SIMPLE.md.jinja2)):
...
<!---->
<img src=".github/README.example.generated.svg" alt="Output of `bash ./examples/simple_example.sh`" />
<!---->
...
- Example:
  - Template: [./examples/SIMPLE.md.jinja2](./examples/SIMPLE.md.jinja2).
  - Generated: [./examples/SIMPLE.generated.md](./examples/SIMPLE.generated.md).
  - Generation script: [./examples/simple_example.sh](./examples/simple_example.sh).
- Long example of many features:
  - Template: [./examples/LONG-EXAMPLE.md.jinja2](./examples/LONG-EXAMPLE.md.jinja2).
  - Generated: [./examples/LONG-EXAMPLE.generated.md](./examples/LONG-EXAMPLE.generated.md).
  - Generation script: [./examples/long_example.sh](./examples/long_example.sh).
...
Used several times in [./examples/LONG-EXAMPLE.md.jinja2](./examples/LONG-EXAMPLE.md.jinja2).
...
Example in [./examples/LONG-EXAMPLE.md.jinja2](./examples/LONG-EXAMPLE.md.jinja2).
...
- Formatting: The `{{` `}}` used to
  ...
  - **Decommentify**: Put the snippet call inside a HTML comment, then use
    ...
    [./examples/LONG-EXAMPLE.md.jinja2](./examples/LONG-EXAMPLE.md.jinja2) for examples.
...
[14]:
  https://img.shields.io/github/commits-since/realazthat/snipinator/v3.1.2/master?style=plastic
[15]:
  https://github.com/realazthat/snipinator/compare/v3.1.2...master
[16]:
...
[20]:
  https://img.shields.io/github/commits-since/realazthat/snipinator/v3.1.2/develop?style=plastic
[21]:
  https://github.com/realazthat/snipinator/compare/v3.1.2...develop
[22]:
  https://img.shields.io/github/commits-since/realazthat/snipinator/v3.1.2/develop?style=plastic
[23]:
  https://github.com/realazthat/snipinator/compare/v3.1.2...develop
